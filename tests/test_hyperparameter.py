...
import numpy as np
import pandas as pd
from ssbc.hyperparameter import sweep_hyperparams_and_collect, sweep_and_plot_parallel_plotly
...
class TestSweepHyperparamsAndCollect:
    ...
    def test_dataframe_columns(self, sample_class_data):
        ...
        expected_cols = [
            'a0', 'd0', 'a1', 'd1',
            'cov', 'sing_rate', 'err_all',
            'err_pred0', 'err_pred1',
            'err_y0', 'err_y1',
            'esc_rate', 'n_total', 'sing_count',
            'm_abst', 'm_doublets'
        ]
