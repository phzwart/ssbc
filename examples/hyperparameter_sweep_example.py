...
def main():
    ...
    print("\nKey Metrics Summary:")
    print(f"   Coverage:      mean={df['cov'].mean():.3f}, "
          f"min={df['cov'].min():.3f}, max={df['cov'].max():.3f}")
    print(f"   Singleton rate: mean={df['sing_rate'].mean():.3f}, "
          f"min={df['sing_rate'].min():.3f}, max={df['sing_rate'].max():.3f}")
    print(f"   Error rate:    mean={df['err_all'].mean():.3f}, "
          f"min={df['err_all'].min():.3f}, max={df['err_all'].max():.3f}")
    print(f"   Escalation:    mean={df['esc_rate'].mean():.3f}, "
    ...
    print(f"      α0={best_automation['a0']:.2f}, δ0={best_automation['d0']:.2f}, "
    ...
    if len(high_sing) > 0:
        ...
        print(f"      α0={best_quality['a0']:.2f}, δ0={best_quality['d0']:.2f}, "
    ...
    if len(balanced) > 0:
        ...
        print(f"      α0={best_balanced['a0']:.2f}, δ0={best_balanced['d0']:.2f}, "
